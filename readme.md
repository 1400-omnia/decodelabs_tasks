...
- Building interactive applications with Streamlit and Tkinter
- Working with datasets and structured data
- Using Git and GitHub for project management and version control

📂 Repository Structure

Each task is organized in its own folder and includes its source code, README, requirements, and project-specific resources.
